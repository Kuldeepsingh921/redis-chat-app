  ...
  return (
    <div className='flex h-screen w-full'>
      ...
      <div className='flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold'>
        <Image src={'/logo.png'} height={763} width={173} alt='rediStash-logo' className='mt-20 w-[420px] z-0 pointer-events-none select-none' />
       
        <p className='text-2xl md:text-3xl  text-balance  z-10'>
          The <span className='bg-red-500 font-bold px-2 text-white'>ULTIMATE</span> chat app
        </p>
      ...
      <div className='flex-1 relative overflow-hidden justify-center items-center hidden md:flex'>
        <Image src={'/hero-right.png'} alt='Hero Image' fill className='object-cover dark:opacity-50 opacity-90 pointer-events-none select-none h-full' />
      </div>
    </div>
  )
}
