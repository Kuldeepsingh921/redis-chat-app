...
export default function Home() {
  ...
  return (
    <main className="flex h-screen flex-col items-center justify-center p-4 md:px-1 py-32 gap-4 border-red-600">
   { /* PREFERENCES TAB */}
   <PreferencesTab />
{/* DOTTED BG */}
      <div className='absolute top-0 z-[-2] h-screen w-screen dark:bg-[#000000] dark:bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] 
        ...
        <div className="z-10 h-full border rounded-lg max-w-5xl w-full min-h-[85hv] text-sm lg:flex">
